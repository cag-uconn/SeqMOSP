...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{magmo/figs/runtime breakdown.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{magmo/figs/runtime breakdown_NOHOLES.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{magmo/figs/pkl_runtime_breakdown.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{magmo/figs/pkl_runtime_breakdownNOHOLES.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{magmo/figs/MAG stage breakdown CPU.png}
